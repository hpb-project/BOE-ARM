...
static FPartation gDefPartationList[] = {
    ...
    {1, FM_IMAGE1_PNAME, IMAGE_1_OFFSET, IMAGE_1_SIZE},
    {2, FM_IMAGE2_PNAME, IMAGE_2_OFFSET, IMAGE_2_SIZE},
    {3, FM_ENV_PNAME, ENV_OFFSET, ENV_SIZE},
};
